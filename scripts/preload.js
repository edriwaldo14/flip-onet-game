class Load extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("footer", "images/footer-1.png");
    ...
    this.load.spritesheet("lines", "images/lines.png", {
      frameWidth: 90,
      frameHeight: 90,
    });
    ...
    //Load all audio
    this.load.audio("click", "audio/click-1.mp3");
    this.load.audio("connected", "audio/click.mp3");
